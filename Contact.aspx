...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function ErrorContact() {
            Swal.fire({
                title: "Failure",
                text: "Form has been not submitted succesfully!",
                icon: "error"
            });
        }
              ...
              <div class="form-row">
                <div class="col-md-6 form-group">
                   ...
                   <%-- <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                    ...
                    <asp:RequiredFieldValidator ControlToValidate="name" ForeColor="Red" SetFocusOnError="true" Display="Dynamic"  ID="RequiredFieldValidator1" runat="server" ErrorMessage="Name is required"></asp:RequiredFieldValidator>
